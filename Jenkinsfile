      ...
      stage('Checkout') { 
         steps {
            ...
            git branch: 'master', 
               ...
               url: 'https://https://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@github.com/Uniandes-isis2603/' + env.GIT_REPO
      ...
      stage('Git Analysis') {
         ...
         steps {
            ...
            withCredentials([usernamePassword(credentialsId: env.GIT_CREDENTIAL_ID, passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
               ...
               sh('git pull https://https://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@github.com/Uniandes-isis2603/${GIT_REPO} master')
               sh('git push https://https://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@github.com/Uniandes-isis2603/${GIT_REPO} master')
            }
         }
      }      
      stage('Build') {
